@DEV-1003 @RCS @UI
Feature: DEV-1003 Create RCS Tab under SMS/Email Reports
  ...
  Scenario: Verify tab content switching
    When I navigate to "Message Reports" page
    And I click on "RCS" tab
    Then the RCS metrics should be displayed
    When I click on "SMS" tab
    Then the SMS metrics should be displayed
    When I click on "Email" tab
    Then the Email metrics should be displayed
    When I click on "RCS" tab again
    Then the RCS metrics should be displayed
